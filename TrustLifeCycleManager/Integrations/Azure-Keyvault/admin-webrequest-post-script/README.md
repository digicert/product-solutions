# Admin Web Request Post Scripts – Azure Key Vault Certificate Import
...
|--------|----------|-----------|
| [`Linux/azure-keyvault-awr.sh`](Linux/azure-keyvault-awr.sh) | Linux (bash) | TLM Agent for Linux |
| [`Windows/azure-keyvault-awr.ps1`](Windows/azure-keyvault-awr.ps1) | Windows (PowerShell) | TLM Agent for Windows |
