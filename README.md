  ...
  <tr>
    ...
    <td align="center" width="33%">
      <a href="https://github.com/digicert/product-solutions/tree/master/TrustLifeCycleManager/Integrations/Cloudflare/Digicert_Generated_CSR">
        ...
        <br><br>
        <strong>Cloudflare (DigiCert Generated CSR)</strong>
      </a>
      <br><br>
...
<table>
  <tr>
    ...
    <td align="center" width="33%">
      ...
      <a href="https://github.com/digicert/product-solutions/tree/master/TrustLifeCycleManager/Integrations/Terraform">
      ...
      <br><br>
      <sub>Infrastructure as Code integration for automated certificate provisioning and lifecycle management.</sub>
    </td>
  </tr>
</table>

<!-- Third Row: Configuration Management & Cloud Integrations -->
<table>
  <tr>
    <td align="center" width="33%">
      <!-- Puppet Configuration Management -->
      <a href="https://github.com/digicert/product-solutions/tree/master/TrustLifeCycleManager/Integrations/Puppet">
        <img src="https://img.shields.io/badge/Puppet-Config_Mgmt-FFAE1A?style=for-the-badge&logo=puppet&logoColor=white" alt="Puppet">
        <br><br>
        <strong>Puppet</strong>
      </a>
      <br><br>
      <sub>Configuration management integration for automated certificate deployment across infrastructure fleets.</sub>
    </td>
    <td align="center" width="33%">
      <!-- Google APIGEE -->
      <a href="https://github.com/digicert/product-solutions/tree/master/TrustLifeCycleManager/Integrations/Google_APIGEE">
        <img src="https://img.shields.io/badge/Google-APIGEE-4285F4?style=for-the-badge&logo=google&logoColor=white" alt="Google APIGEE">
        <br><br>
        <strong>Google APIGEE</strong>
      </a>
      <br><br>
      <sub>Secure API gateway certificate management for Google Cloud APIGEE platform integrations.</sub>
    </td>
    <td align="center" width="33%">
      <!-- Kemp LoadBalancer -->
...
<!-- Fourth Row: Microsoft Solutions -->
<table>
  <tr>
    <td align="center" width="33%">
...
<table>
  <tr>
    ...
    <td align="center" width="33%">
      <!-- TmaxSoft WebtoB -->
      <a href="https://github.com/digicert/product-solutions/tree/master/TrustLifeCycleManager/Integrations/WebtoB">
        <img src="https://img.shields.io/badge/TmaxSoft-WebtoB-1E3A8A?style=for-the-badge&logo=data:image/svg+xml;base64," alt="TmaxSoft WebtoB">
        <br><br>
        <strong>TmaxSoft WebtoB</strong>
      </a>
      <br><br>
